    ...
    <div class="ui raised very padded text container segment" id="cont">
        <div class="ui segment">
            ...
            <div class="ui right floated buttons">
                <button class="ui button" onclick="location.href='login.php'">Se connecter</button>
                <div class="or" data-text="ou"></div>
                <button class="ui positive button" onclick="location.href='inscription.html'">S'inscrire</button>
            </div>
            ...
            <div id="content">
                ...
                if (isset($_GET['deconnexion'])) {
                    ...
                    echo "<br><a href='index.php?deconnexion=true'><span>Déconnexion</span></a>";
                }
                ?>
